	...
	<div id="content">
		...
		<div class='fixed-action-button sectioned' id="FABStatic" style="display:none">
				...
				<ol class='fab-btn-list' style='margin: 0; padding: 0; display: none;' reversed id='fabBtnList'>
					 <li><a class='btn-floating fab-btn-sm scale-transition scale-out' data-tooltip='Heading' onclick='createFABItem("0","New Heading","undefined");'><img class='fab-icon' src='../Shared/icons/heading-icon.svg' alt='Lorem ipsum'></a></li>
						<li><a class='btn-floating fab-btn-sm scale-transition scale-out' data-tooltip='Section' onclick='createFABItem("1","New Section","undefined");'><img class='fab-icon' src='../Shared/icons/section-icon.svg' alt='Lorem ipsum'></a></li>
						<li><a class='btn-floating fab-btn-sm scale-transition scale-out' data-tooltip='Moment' onclick='createFABItem("4","New Moment","undefined");'><img class='fab-icon' src='../Shared/icons/moment-icon.svg' alt='Lorem ipsum'></a></li>
						<li><a class='btn-floating fab-btn-sm scale-transition scale-out' data-tooltip='Test' onclick='createFABItem("3","New Test","undefined");'><img class='fab-icon' src='../Shared/icons/test-icon.svg' alt='Lorem ipsum'></a></li>
						...
						<li><a class='btn-floating fab-btn-sm scale-transition scale-out' data-tooltip='Code' onclick='createFABItem("2","New Code","undefined");'><img class='fab-icon' src='../Shared/icons/code-icon.svg' alt='Lorem ipsum'></a></li>
						<li><a class='btn-floating fab-btn-sm scale-transition scale-out' data-tooltip='Group activity' onclick='createFABItem("6","New Group","undefined");'><img class='fab-icon' src='../Shared/icons/group-icon.svg' alt='Lorem ipsum'></a></li>
		...
		<!-- Small FAB Button in top in the header of sectioned -->
			...
			<div style="margin:10px;">
				<img src="../Shared/icons/right_complement.svg" id="sectionList_arrowStatisticsOpen" alt="Lorem ipsum">
				<img src="../Shared/icons/desc_complement.svg" id="sectionList_arrowStatisticsClosed" alt="Lorem ipsum">
			</div>
			...
			<div class='fixed-action-button2 sectioned2'  id="FABStatic2" style="display:none">
				...
				<ol class='fab-btn-list2' style='display: none;'  reversed id='fabBtnList2'>
							<li><a class='btn-floating fab-btn-sm2 scale-transition scale-out' data-tooltip='Heading' onclick='createFABItem("0","New Heading","TOP");'><img class='fab-icon' src='../Shared/icons/heading-icon.svg' alt='Lorem ipsum'></a></li>
							<li><a class='btn-floating fab-btn-sm2 scale-transition scale-out' data-tooltip='Section' onclick='createFABItem("1","New Section","TOP");'><img class='fab-icon' src='../Shared/icons/section-icon.svg' alt='Lorem ipsum'></a></li>
							<li><a class='btn-floating fab-btn-sm2 scale-transition scale-out' data-tooltip='Moment' onclick='createFABItem("4","New Moment","TOP");'><img class='fab-icon' src='../Shared/icons/moment-icon.svg' alt='Lorem ipsum'></a></li>
							<li><a class='btn-floating fab-btn-sm2 scale-transition scale-out' data-tooltip='Test' onclick='createFABItem("3","New Test","TOP");'><img class='fab-icon' src='../Shared/icons/test-icon.svg' alt='Lorem ipsum'></a></li>
							...
							<li><a class='btn-floating fab-btn-sm2 scale-transition scale-out' data-tooltip='Code' onclick='createFABItem("2","New Code","TOP");'><img class='fab-icon' src='../Shared/icons/code-icon.svg' alt='Lorem ipsum'></a></li>
							<li><a class='btn-floating fab-btn-sm2 scale-transition scale-out' data-tooltip='Group activity' onclick='createFABItem("6","New Group","TOP");'><img class='fab-icon' src='../Shared/icons/group-icon.svg' alt='Lorem ipsum'></a></li>
		...
		<div id='statisticsList' style="">
				<div id='statistics' class='statistics' style='cursor:pointer;'>
						<div style='margin:10px;'>
								<img src='../Shared/icons/right_complement.svg' id='arrowStatisticsOpen' alt='Lorem ipsum'>
								<img src='../Shared/icons/desc_complement.svg' id='arrowStatisticsClosed' alt='Lorem ipsum'>
						</div>
